...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body p-5">
            <div class="mb-3 d-flex justify-content-end">
                <a href="{{ route('admin.academic-year-strand-subjects.create', ['academic_year' => $adviser->academic_year_id, 'strand' => $adviser->strand_id, 'academic_year_strand_adviser_id' => $adviser->id]) }}" class="btn btn-info"><i class="ti ti-book-plus me-2"></i>Add Subject</a>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body p-5">
            <div class="mb-3 d-flex justify-content-end">
                <a href="{{ route('admin.academic-year-strand-sections.create', ['academic_year' => $adviser->academic_year_id, 'strand' => $adviser->strand_id, 'academic_year_strand_adviser_id' => $adviser->id]) }}" class="btn btn-info"><i class="ti ti-plus me-2"></i>Assign Section</a>
            </div>
