...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
    ...
    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
        <div class="mb-2">
          ...
          <div class="mb-2 ms-2">
            <a href="{{ route('admin.strand-subjects.create', ['strand' => $strand->id]) }}" class="btn bg-info d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add to Subject</a>
        </div>
    </div>
</div>
<!-- /Breadcrumb -->
