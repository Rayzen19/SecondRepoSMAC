...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
    <div class="my-auto mb-2">
        <h2 class="mb-1">Grade 11 Section & Advisers</h2>
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="ti ti-smart-home"></i></a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.section-advisers.index') }}">Section & Advisers</a></li>
                <li class="breadcrumb-item active" aria-current="page">Grade 11</li>
            </ol>
        </nav>
    </div>
    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
        <a href="{{ route('admin.section-advisers.grade12') }}" class="btn btn-info">
            <i class="ti ti-school me-2"></i>View Grade 12 Sections
        </a>
    </div>
</div>
@endsection
...
<div class="content">
    ...
    <div class="alert alert-primary mb-3 border-0 shadow-sm">
        <i class="ti ti-info-circle me-2"></i>
        <strong>Grade 11 Sections Only</strong> - Showing all Grade 11 sections across all strands.
    </div>
    ...
    <div class="row mb-3">
        <div class="col-12 mb-3">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h5 class="mb-0"><i class="ti ti-building-community me-2"></i>Section Advisers - Grade 11</h5>
