...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
    ...
    <!-- <div class="d-flex my-xl-auto right-content align-items-center flex-wrap "> -->
        ...
        <!-- <div class="mb-2 ms-2">
            <a href="{{ route('admin.academic-year-strand-subjects.create', ['academic_year' => $year->id]) }}" class="btn bg-info d-flex align-items-center"><i class="ti ti-book-plus me-2"></i>Add Subject</a>
        </div> -->
        <!-- <div class="mb-2 ms-2">
                ...
                <div class="tab-content pt-4" id="ayTabContent">
                    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                         <div class="d-flex justify-content-end mb-2">
                            <a href="{{ route('admin.academic-years.edit', $year) }}" class="btn btn-sm bg-info"><i class="ti ti-edit me-2"></i>Edit</a>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                    ...
                    @if($status !== 'pending')
                        <div class="tab-pane fade" id="students" role="tabpanel" aria-labelledby="students-tab">
                            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-2">
                                ...
                                <a href="{{ route('admin.student-enrollments.create', ['academic_year_id' => $year->id]) }}" class="btn btn-sm bg-info"><i class="ti ti-user-plus me-1"></i>New Enrollment</a>
                    ...
                    <div class="tab-pane fade" id="advisers" role="tabpanel" aria-labelledby="advisers-tab">
                        <div class="d-flex justify-content-end mb-2">
                            <a href="{{ route('admin.academic-year-strand-advisers.create', ['academic_year' => $year->id]) }}" class="btn btn-sm bg-info"><i class="ti ti-plus me-2"></i>Assign Strand</a>
                        </div>
                    ...
                    <div class="tab-pane fade" id="sections" role="tabpanel" aria-labelledby="sections-tab">
                        <div class="d-flex justify-content-end mb-2">
                            <a href="{{ route('admin.academic-year-strand-sections.create', ['academic_year' => $year->id]) }}" class="btn btn-sm bg-info"><i class="ti ti-plus me-2"></i>Assign Section</a>
                        </div>
