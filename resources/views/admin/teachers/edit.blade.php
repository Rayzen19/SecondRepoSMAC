                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="specialization" id="specializationInput" class="form-control" value="{{ old('specialization', $teacher->specialization) }}" placeholder="e.g., Programming, English, Math">
...
<script>
// Filter Subjects by Specialization (edit)
