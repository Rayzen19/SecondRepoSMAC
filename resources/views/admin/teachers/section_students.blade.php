...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
    ...
    <h2 class="mb-1">Section Students • {{ data_get($sectionAssignment, 'section.name', 'Section') }}</h2>
        <nav>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Section Students</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row g-3 align-items-center">
                <div class="col-md-8">
                    <h4 class="mb-1">{{ data_get($sectionAssignment, 'strand.name', 'Strand') }} • Section {{ data_get($sectionAssignment, 'section.name', 'N/A') }}</h4>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                ...
                <div>
                    <a href="{{ route('admin.teachers.section-students.export', [$teacher, $academicYear, $sectionAssignment]) }}" class="btn btn-sm btn-outline-secondary">
