...
<body class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="w-full max-w-md p-8 bg-white rounded shadow">
        ...
        <form method="POST" action="{{ route('guardian.login.submit') }}" id="guardian-login-form">
            @csrf
            <div class="mb-4">
            ...
            <button type="submit" id="login-btn" class="w-full bg-orange-600 text-white py-2 rounded hover:bg-orange-700">Login</button>
        </form>
    </div>
    <script>
        $(document).ready(function() {
            ...
            $('#guardian-login-form').on('submit', function(e) {
