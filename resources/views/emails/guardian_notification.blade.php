...
<body style="font-family: Arial, Helvetica, sans-serif; color:#111;">
    <div style="max-width:600px;margin:0 auto;padding:24px;">
        ...
        <div style="background:#fef3c7;border:1px solid #fde68a;border-radius:8px;padding:16px;margin:16px 0;">
            ...
            <p style="margin:0 0 8px;"><strong>Temporary Password:</strong> {{ $studentPassword }}</p>
        </div>
        ...
        <div style="background:#dcfce7;border:1px solid #86efac;border-radius:8px;padding:16px;margin:16px 0;">
            ...
            <p style="margin:0 0 8px;"><strong>Guardian Email:</strong> {{ $guardianEmail }}</p>
            <p style="margin:0 0 8px;"><strong>Guardian Password:</strong> {{ $guardianPassword }}</p>
        </div>
