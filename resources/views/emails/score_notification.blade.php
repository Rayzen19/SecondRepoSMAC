...
<body>
    ...
    <div class="content">
        ...
        <p>This is to inform you that a new assessment score has been recorded for <strong>{{ $studentName }}</strong>.</p>
        ...
        <div class="score-card">
            ...
            <div class="score-detail">
                ...
                <span class="score-value">{{ $assessmentName }}</span>
            </div>
            
            <div class="score-detail">
                <label>Type:</label>
                <span class="badge 
                    @if($assessmentType === 'WW') badge-ww
                    @elseif($assessmentType === 'PT') badge-pt
                    @elseif($assessmentType === 'QA') badge-qa
                    @endif">
                    {{ $assessmentType }}
                </span>
            </div>
            ...
            <div class="score-detail">
                <label>Subject:</label>
                <span class="score-value">{{ $subject }}</span>
            </div>
            
            <div class="score-detail">
                <label>Academic Year:</label>
                <span class="score-value">{{ $academicYear }}</span>
            </div>
            
            <div class="score-detail">
                <label>Term:</label>
                <span class="score-value">{{ $term }}</span>
            </div>
            
            <div class="score-detail">
                <label>Date Given:</label>
                <span class="score-value">{{ $dateGiven }}</span>
            </div>
        </div>
    ...
    <div class="footer">
        ...
        <p>&copy; {{ date('Y') }} St. Matthew Senior High School. All rights reserved.</p>
    </div>
</body>
</html>
