    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                ...
                <button class="btn btn-sm bg-info new-conversation-btn" data-bs-toggle="modal" data-bs-target="#newConversationModal">
            ...
            <div class="card-footer bg-white py-3">
                <form id="send-form" enctype="multipart/form-data">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn bg-info send-btn d-flex align-items-center" type="submit">
