        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="text-center mb-4">
                    <img src="{{ asset('assets/images/Image.png') }}" alt="SMAC Logo" height="100" class="mb-2">
                </div>
                <div class="card shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        <h4 class="mb-3 text-center">Student Sign in</h4>
                        @if (session('status'))
                        ...
                        <form method="POST" action="{{ url()->current() }}" novalidate>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="{{ route('student.auth.forgotForm') }}" class="text-primary">Forgot password?</a>
                            </div>
