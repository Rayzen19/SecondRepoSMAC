...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item ms-2"><a href="{{ route('login') }}" class="btn btn-primary btn-sm">Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <a href="{{ route('login') }}" class="btn btn-cta btn-lg">Login</a>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <article class="news-card h-100 p-0 overflow-hidden">
                        ...
                        <img src="{{ $announcement->image }}" alt="{{ $announcement->title }}" class="news-img w-100" />
                        @else
                        ...
                        <div class="p-3">
                            ...
                            <p class="text-muted small mb-2">{{ Str::limit(strip_tags($announcement->content), 120) }}</p>
                            @if($announcement->published_at)
                            <div class="text-muted small">Published: {{ $announcement->published_at->format('F d, Y') }}</div>
                            @endif
                        </div>
                    </article>
                </div>
    ...
    <footer id="contact" class="py-4">
        <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center">
            <div class="small text-muted">&copy; {{ date('Y') }} St. Matthew Academy of Cavite</div>
