...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (Schema::hasTable('academic_year_strand_subjects')) {
            // Table already exists (e.g., created manually or by earlier migrations). Skip creation.
            return;
        }

        // Defer until dependencies are present to avoid FK errors during migrate:fresh
