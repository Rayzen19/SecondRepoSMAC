    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-white corporate-nav shadow-sm sticky-top">
        <div class="container px-lg-5">
            <a class="navbar-brand d-flex align-items-center text-dark" href="#">
                <img src="<?php echo e(asset('assets/images/image.png')); ?>" alt="Logo" height="36" class="me-2 logo-img">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                ...
                <div class="ms-lg-3 d-flex gap-2">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-sm fw-semibold rounded-pill px-4">Login</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg rounded-pill px-4">Get Started</a>
