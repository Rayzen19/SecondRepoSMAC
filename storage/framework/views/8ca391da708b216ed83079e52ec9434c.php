...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/image.png')); ?>">
    ...
    <nav class="lm-navbar navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="<?php echo e(asset('assets/images/image.png')); ?>" alt="logo" height="36" class="me-2">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="hero-visual">
                        <img src="<?php echo e(asset('assets/images/image.png')); ?>" alt="campus" class="img-fluid rounded shadow-sm">
                    </div>
                </div>
            </div>
        </div>
