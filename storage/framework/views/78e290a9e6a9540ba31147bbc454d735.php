...
<body>
    <div class="overlay">
        <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" class="logo"> St. Matthew Academy of Cavite <div class="error-code">404</div>

        <body style="background: linear-gradient(135deg, #f8fafc 60%, #e3342f10 100%); background-image: url('<?php echo e(asset('assets/images/logo.png')); ?>'), linear-gradient(135deg, #f8fafc 60%, #e3342f10 100%); background-repeat: no-repeat; background-position: center 15vh, center center; background-size: 30vw auto, cover;">
            ...
            <div class="tips">
                ...
                <ul style="margin:0.5em 0 0 1.2em; padding:0;">
                    ...
                    <li>Return to the <a href="<?php echo e(url('/')); ?>">homepage</a>.</li>
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn">Go to Home</a>
            <div class="links">
                <a href="<?php echo e(url('/courses')); ?>">Browse Courses</a> |
...
</html><?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/errors/404.blade.php ENDPATH**/ ?>