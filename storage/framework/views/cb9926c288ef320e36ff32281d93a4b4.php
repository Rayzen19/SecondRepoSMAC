...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
    ...
    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
        <div class="mb-2">
            <a href="<?php echo e(route('admin.announcements.create')); ?>" class="btn btn-primary d-flex align-items-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e(route('admin.announcements.edit', $announcement)); ?>" class="btn btn-sm btn-primary">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-4">
                                ...
                                <a href="<?php echo e(route('admin.announcements.create')); ?>" class="btn btn-primary btn-sm mt-2">
