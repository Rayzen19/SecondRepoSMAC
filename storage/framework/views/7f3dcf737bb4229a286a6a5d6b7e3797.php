    ...
    <div class="container-fluid px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                ...
                <div class="ms-lg-3 d-flex gap-2">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-info text-white fw-semibold shadow-sm rounded-pill px-4"><i class="ti ti-lock me-1"></i> Login</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-info btn-lg text-white fw-semibold shadow-sm rounded-pill px-4"><i class="ti ti-layout-navbar me-1"></i> Login</a>
...
</html><?php /**PATH /var/www/laravelapp/resources/views/welcome.blade.php ENDPATH**/ ?>