                ...
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <button type="button" 
                                ...
                                onclick="assignToSection(<?php echo e($section->id); ?>, '<?php echo e($section->grade); ?> <?php echo e($section->name); ?>', '<?php echo e($strandCode); ?>', '<?php echo e($color); ?>')"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($student->academic_year): ?>
                                        <span class="badge bg-success-subtle text-success"><?php echo e($student->academic_year); ?></span>
                                    <?php else: ?>
