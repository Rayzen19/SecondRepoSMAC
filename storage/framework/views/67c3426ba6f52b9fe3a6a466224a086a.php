...
<div class="content">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.assigning-list.index')); ?>" method="GET" id="filterForm">
                <div class="row g-3">
                    <!-- Search -->
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="strand" class="form-select" onchange="document.getElementById('filterForm').submit()">
                            <option value="all" <?php echo e(request('strand') == 'all' || !request('strand') ? 'selected' : ''); ?>>All Strands</option>
                            <?php $__currentLoopData = $strands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $strand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($strand->code); ?>" <?php echo e(request('strand') == $strand->code ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="grade_level" class="form-select" onchange="document.getElementById('filterForm').submit()">
                            <option value="all" <?php echo e(request('grade_level') == 'all' || !request('grade_level') ? 'selected' : ''); ?>>All Grade Levels</option>
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <a href="<?php echo e(route('admin.assigning-list.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="card-title mb-0">
                    ...
                    <span class="badge bg-primary ms-2"><?php echo e($students->total()); ?> Total</span>
                </h5>
                <div class="text-muted small">
                    <?php if(request('strand') && request('strand') !== 'all'): ?>
                        Filtered by Strand: <strong><?php echo e(request('strand')); ?></strong>
                    <?php endif; ?>
                    <?php if(request('grade_level') && request('grade_level') !== 'all'): ?>
                        | Grade: <strong><?php echo e(request('grade_level')); ?></strong>
                    <?php endif; ?>
                </div>
            </div>
            
            <!-- Filter Info Message -->
            <?php if((request('strand') && request('strand') !== 'all') || (request('grade_level') && request('grade_level') !== 'all')): ?>
                <div class="alert alert-info alert-dismissible fade show mb-3" role="alert">
                    <i class="ti ti-info-circle me-2"></i>
                    <strong>Filter Active:</strong> 
                    Section buttons are now filtered to match your selected 
                    <?php if(request('strand') && request('strand') !== 'all'): ?>
                        <strong>Strand (<?php echo e(request('strand')); ?>)</strong>
                    <?php endif; ?>
                    <?php if((request('strand') && request('strand') !== 'all') && (request('grade_level') && request('grade_level') !== 'all')): ?>
                        and
                    <?php endif; ?>
                    <?php if(request('grade_level') && request('grade_level') !== 'all'): ?>
                        <strong>Grade Level (<?php echo e(request('grade_level')); ?>)</strong>
                    <?php endif; ?>
                    criteria.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                ...
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <button type="button" 
                            ...
                            data-section-name="<?php echo e($section->grade); ?> <?php echo e($section->name); ?>"
                            data-strand-code="<?php echo e($strandCode); ?>"
                            data-student-count="<?php echo e($studentCount); ?>"
                            data-badge-color="<?php echo e($color); ?>"
                            title="<?php echo e($strandName); ?> - Grade <?php echo e($section->grade); ?> (<?php echo e($studentCount); ?>/30 students)"
                            <?php if($isFull): ?> disabled <?php endif; ?>>
                            <i class="ti ti-users me-1"></i>G<?php echo e($section->grade); ?> <?php echo e($section->name); ?>

                            <?php if($strandCode !== 'N/A'): ?>
                                <span class="badge bg-light text-dark ms-1" style="font-size: 0.7rem;"><?php echo e($strandCode); ?></span>
                            <?php endif; ?>
                            <span class="badge ms-1 <?php echo e($isFull ? 'bg-danger' : ($studentCount >= 24 ? 'bg-warning' : 'bg-success')); ?>" style="font-size: 0.7rem;">
                                <?php echo e($studentCount); ?>/30
                            </span>
                            <?php if($isFull): ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input student-checkbox" 
                                               ...
                                               data-student-no="<?php echo e($student->student_number); ?>"
                                               data-student-strand="<?php echo e($student->program); ?>">
                                    </div>
                                </td>
                                <td class="text-center"><?php echo e($students->firstItem() + $index); ?></td>
                                <td>
                                    <span class="badge bg-secondary font-monospace"><?php echo e($student->student_number); ?></span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm me-2">
                                            <?php if($student->profile_picture): ?>
                                                <img src="<?php echo e(asset('storage/' . $student->profile_picture)); ?>" 
                                        ...
                                        <div>
                                            <div class="fw-semibold">
                                                ...
                                                <?php if($student->middle_name): ?>
                                                    <?php echo e(substr($student->middle_name, 0, 1)); ?>.
                                                <?php endif; ?>
                                                <?php if($student->suffix): ?>
                                                    <?php echo e($student->suffix); ?>
                                ...
                                <td>
                                    ...
                                    <?php elseif(strtolower($student->gender) === 'female'): ?>
                                ...
                                <td>
                                    <?php if($student->program): ?>
                                        <span class="badge bg-primary-subtle text-primary"><?php echo e($student->program); ?></span>
                                    <?php else: ?>
                                ...
                                <td>
                                    <?php if($student->grade_level): ?>
                                        <span class="badge bg-success-subtle text-success"><?php echo e($student->grade_level); ?></span>
                                    <?php else: ?>
                                        <span class="text-muted">—</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <span class="section-display-<?php echo e($student->id); ?> text-muted small">Not assigned</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('admin.students.show', $student->student_number)); ?>">
                                                    <i class="ti ti-eye me-2"></i>View Details
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('admin.students.edit', $student->student_number)); ?>">
                            ...
                            <tr>
                                <td colspan="10" class="text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <?php if(request('strand') || request('grade_level') || request('search')): ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn bg-info" id="confirmAssignmentBtn" data-bs-dismiss="modal">
...
<script>
    ...
    const SAVE_ASSIGNMENTS_URL = <?php echo json_encode(route('admin.assigning-list.save-assignments')); ?>;
    ...
    async function saveAllAssignments() {
        ...
        try {
            const response = await fetch('<?php echo e(route('admin.assigning-list.save-assignments')); ?>', {
                method: 'POST',
                headers: {
    ...
    function loadSavedAssignments() {
        ...
        const existingAssignments = <?php echo json_encode($existingAssignments ?? [], 15, 512) ?>;
        const savedAssignments = <?php echo json_encode(session('student_assignments', []), 512) ?>;
        ...
        const sectionsData = <?php echo json_encode($sections, 15, 512) ?>;
...
<?php echo $__env->make('admin.components.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/admin/assigning_list/index.blade.php ENDPATH**/ ?>