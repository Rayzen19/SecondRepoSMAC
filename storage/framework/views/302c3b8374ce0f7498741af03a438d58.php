        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h4 class="fw-bold mb-1"><?php echo e($admin->name); ?></h4>
                    <p class="text-muted mb-3">
                        <i class="ti ti-shield-check me-1"></i>
                        <?php if($admin->type === 'co-admin'): ?>
                            Co-Administrator
                        <?php else: ?>
                            Administrator
                        <?php endif; ?>
                    ...
                    <p class="mb-4">
                        <i class="ti ti-mail me-1"></i><?php echo e($admin->email); ?>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($admin->created_at ? $admin->created_at->format('F d, Y') : 'N/A'); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-bold">Last Updated:</td>
                                    <td><?php echo e($admin->updated_at ? $admin->updated_at->format('F d, Y h:i A') : 'N/A'); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between p-3 border rounded bg-light">
                        ...
                        <a href="<?php echo e(route('admin.profile.password.edit')); ?>" class="btn btn-danger">
...
<?php echo $__env->make('admin.components.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/admin/profile/show.blade.php ENDPATH**/ ?>