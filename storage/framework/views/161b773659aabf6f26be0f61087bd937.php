...
<script>
    (function(){
        ...
        function loadConversation(userId, scrollToBottom = true) {
            fetch("<?php echo e(url('/student/messenger/conversation/')); ?>/" + userId)
                .then(r => r.json())
                .then(data => {
        ...
        function checkForNewMessages() {
            ...
            fetch("<?php echo e(url('/student/messenger/conversation/')); ?>/" + currentUserId)
                .then(r => r.json())
                .then(data => {
        ...
        sendForm.addEventListener('submit', function(e){
            ...
            fetch("<?php echo e(route('student.messages.sendConversation')); ?>", {
                method: 'POST',
                headers: {
        ...
        function sendTypingStatus(isTyping) {
            ...
            fetch("<?php echo e(route('student.messages.typing')); ?>", {
                method: 'POST',
                headers: {
        ...
        function updateUnreadCounts() {
            fetch("<?php echo e(route('student.api.unread-counts-by-partner')); ?>")
                .then(r => r.json())
                .then(data => {
        ...
        function loadAllUsers() {
            ...
            fetch("<?php echo e(url('/student/api/all-users')); ?>")
                .then(r => r.json())
                .then(users => {
                    allUsers = users;
        ...
        function updateConversationList(messageData) {
            ...
            if (!existingConv && senderId !== Number('<?php echo e(auth()->id()); ?>')) {
...
<?php echo $__env->make('student.components.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/student/messages/messenger.blade.php ENDPATH**/ ?>