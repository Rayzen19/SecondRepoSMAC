                ...
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <h5 class="mb-0">
                            ...
                            <span class="badge bg-primary ms-2"><?php echo e($totalStudents); ?></span>
                        </h5>
                    ...
                    <div class="col-md-9">
                        <div class="row g-2">
                            <div class="col-md-8">
                                <form method="GET" action="<?php echo e(route('teacher.students.index')); ?>" class="row g-2" id="filterForm">
                                    <div class="col-md-2">
                                        <select name="year_level" class="form-select form-select-sm" onchange="this.form.submit()">
                                            ...
                                            <?php $__currentLoopData = $yearLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($level); ?>" <?php echo e($selectedYearLevel == $level ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-2">
                                        <select name="strand" class="form-select form-select-sm" onchange="this.form.submit()">
                                            ...
                                            <?php $__currentLoopData = $strands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $strandId => $strandCode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($strandId); ?>" <?php echo e($selectedStrand == $strandId ? 'selected' : ''); ?>>
                                                    <?php echo e($strandCode); ?>
                                    ...
                                    <div class="col-md-2">
                                        <select name="section" class="form-select form-select-sm" onchange="this.form.submit()">
                                            ...
                                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionId => $sectionName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sectionId); ?>" <?php echo e($selectedSection == $sectionId ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-2">
                                        <select name="subject" class="form-select form-select-sm" onchange="this.form.submit()">
                                            ...
                                            <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subjectId => $subjectName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($subjectId); ?>" <?php echo e($selectedSubject == $subjectId ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-1">
                                        <?php if($selectedYearLevel || $selectedStrand || $selectedSection || $selectedSubject || $search): ?>
                                            <a href="<?php echo e(route('teacher.students.index')); ?>" class="btn btn-sm btn-outline-secondary w-100" title="Clear Filters">
                                                <i class="ti ti-x"></i>
                                            </a>
                                        <?php else: ?>
                                            <button type="submit" class="btn btn-sm bg-info w-100" title="Search">
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" class="form-check-input student-checkbox" 
                                               ...
                                               data-student-name="<?php echo e($student['full_name']); ?>"
                                               data-student-number="<?php echo e($student['student_number']); ?>">
                                    </td>
                                    ...
                                    <td>
                                        <span class="badge bg-primary">Grade <?php echo e($student['grade_level']); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-success"><?php echo e($student['strand']); ?></span>
                                    </td>
                                    <td><?php echo e($student['section']); ?></td>
                                    <td>
                                        <small class="text-muted">
                                            <i class="ti ti-mail me-1"></i><?php echo e($student['email']); ?>

                                        </small>
                                    </td>
                                    <td>
                                        <?php if($student['assignment_id']): ?>
                                            <a href="<?php echo e(route('teacher.class-records.show', ['assignment' => $student['assignment_id']])); ?>" 
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-3">
                                        <h4 class="mb-0"><?php echo e($students->where('gender', 'Male')->count()); ?></h4>
                                        <small>Male Students</small>
                                    </div>
                                    <div class="col-md-3">
                                        <h4 class="mb-0"><?php echo e($students->where('gender', 'Female')->count()); ?></h4>
                                        <small>Female Students</small>
                                    </div>
                                    <div class="col-md-3">
                                        <h4 class="mb-0"><?php echo e($yearLevels->count()); ?></h4>
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        ...
                        <?php if($selectedYearLevel || $selectedStrand || $selectedSection || $selectedSubject || $search): ?>
                            ...
                            <a href="<?php echo e(route('teacher.students.index')); ?>" class="btn bg-info">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn bg-info" onclick="submitAssessment()">Submit</button>
            </div>
        </div>
    </div>
</div>
...
function submitAssessment() {
    ...
    // Show loading
    const submitBtn = document.querySelector('#addAssessmentModal .bg-info');
    ...
    $.ajax({
        url: '<?php echo e(route("teacher.assessments.store")); ?>',
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
<?php echo $__env->make('teacher.components.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/teacher/students/index.blade.php ENDPATH**/ ?>