...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            ...
            <p style="margin: 5px 0 0 0; opacity: 0.9;"><?php echo e($appName); ?></p>
        </div>
        ...
        <div class="email-body">
            ...
            <p>We received a request to reset the password for your <strong><?php echo e($userType); ?></strong> account at <?php echo e($appName); ?>.</p>
            ...
            <div class="otp-box">
                ...
                <div class="otp-expiry">⏰ Valid for <?php echo e($expiresIn); ?> minutes only</div>
            </div>
            ...
            <div class="security-notice">
                ...
                <ul style="margin: 10px 0; padding-left: 20px;">
                    <li>This OTP will expire in <strong><?php echo e($expiresIn); ?> minutes</strong></li>
        ...
        <div class="email-footer">
            <div class="footer-info">
                <strong><?php echo e($appName); ?></strong><br>
...
<?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/emails/password_reset_otp.blade.php ENDPATH**/ ?>