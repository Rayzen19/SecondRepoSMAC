            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('student.profile.edit')); ?>" class="btn bg-info">
            ...
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    <?php if($student->profile_picture): ?>
                        <img src="<?php echo e(route('media.profile_picture', pathinfo($student->profile_picture, PATHINFO_BASENAME))); ?>" 
                             alt="Profile Picture" 
                             id="preview-image"
                    ...
                    <form action="<?php echo e(route('student.profile.picture.update')); ?>" method="POST" enctype="multipart/form-data" class="mb-2">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($student->profile_picture): ?>
                        <form action="<?php echo e(route('student.profile.picture.delete')); ?>" method="POST" onsubmit="return confirm('Are you sure you want to remove your profile picture?');">
                            <?php echo csrf_field(); ?>
            ...
            <div class="card shadow-sm mt-3">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('student.profile.password.edit')); ?>" class="btn btn-outline-primary w-100">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><?php echo e($student->student_number); ?></p>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="mb-0"><?php echo e($student->first_name); ?></p>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold text-muted small">Middle Name</label>
                            <p class="mb-0"><?php echo e($student->middle_name ?? '-'); ?></p>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold text-muted small">Last Name</label>
                            <p class="mb-0"><?php echo e($student->last_name); ?><?php echo e($student->suffix ? ' ' . $student->suffix : ''); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-muted small">Gender</label>
                            <p class="mb-0"><?php echo e(ucfirst($student->gender)); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-muted small">Birthdate</label>
                            <p class="mb-0"><?php echo e(\Carbon\Carbon::parse($student->birthdate)->format('F d, Y')); ?></p>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><?php echo e($student->mobile_number); ?></p>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-bold text-muted small">Address</label>
                            <p class="mb-0"><?php echo e($student->address ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><?php echo e($student->program); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-muted small">Academic Year</label>
                            <p class="mb-0"><?php echo e($student->academic_year); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <p class="mb-0"><?php echo e($student->guardian_name ?? '-'); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-muted small">Guardian Contact</label>
                            <p class="mb-0"><?php echo e($student->guardian_contact); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-muted small">Guardian Email</label>
                            <p class="mb-0"><?php echo e($student->guardian_email); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('student.components.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/student/profile/show.blade.php ENDPATH**/ ?>