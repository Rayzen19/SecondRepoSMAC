                    ...
                    <form method="GET" action="<?php echo e(route('teacher.scores.index')); ?>" class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="term" id="term" class="form-select" onchange="this.form.submit()">
                                <option value="midterm" <?php echo e($selectedTerm === 'midterm' ? 'selected' : ''); ?>>Midterm (1st)</option>
                                <option value="finals" <?php echo e($selectedTerm === 'finals' ? 'selected' : ''); ?>>Finals (2nd)</option>
                            </select>
                        </div>
                        <div class="col-md-2">
