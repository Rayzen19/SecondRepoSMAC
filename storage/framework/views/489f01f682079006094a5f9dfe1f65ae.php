...
<div class="content">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="strandFilter" onchange="filterSections()">
                        ...
                        <?php $__currentLoopData = $strands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $strand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($strand->code); ?>"><?php echo e($strand->code); ?> - <?php echo e(Str::limit($strand->name, 25)); ?></option>
    ...
    <div class="row mb-3">
        ...
        <?php $__currentLoopData = $strands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $strand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-6 col-xl-3 mb-3 strand-card" data-strand="<?php echo e($strand->code); ?>">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header text-white" style="background-color: #467fcf;">
                        <h6 class="mb-0 text-white">
                            <i class="ti ti-building me-2"></i><?php echo e($strand->code); ?> - <?php echo e(Str::limit($strand->name, 30)); ?>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center mb-2 px-1">
                            ...
                            <div class="btn-group" role="group" aria-label="View subjects">
                                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="viewStrandSubjects('<?php echo e($strand->code); ?>', '11')" title="View Grade 11 Subjects">
                                    <i class="ti ti-eye me-1"></i>G11
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="viewStrandSubjects('<?php echo e($strand->code); ?>', '12')" title="View Grade 12 Subjects">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <?php if($grade11Sections->isNotEmpty() || $grade12Sections->isNotEmpty()): ?>
                                <!-- Grade 11 Sections -->
                                <?php if($grade11Sections->isNotEmpty()): ?>
                                    <div class="list-group-item px-2 py-1 bg-light">
                                        <small class="fw-bold text-primary">
                                            <i class="ti ti-school me-1"></i>Grade 11 Sections
                                        </small>
                                    </div>
                                    <?php $__currentLoopData = $grade11Sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $color = $colors[$index % count($colors)];
                                        ?>
                                        <div class="list-group-item px-2 py-2 section-item" data-section="<?php echo e($section->id); ?>" data-grade="11">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div>
                                                    <span class="badge bg-<?php echo e($color); ?>">
                                                        <?php echo e($section->grade); ?> <?php echo e($section->name); ?>

                                                    </span>
                                                    <button type="button" 
                                                            class="btn btn-sm btn-outline-primary ms-2 view-section-btn" 
                                                            data-strand="<?php echo e($strand->code); ?>" 
                                                    ...
                                                    <button type="button" 
                                                            ...
                                                            data-section="<?php echo e($section->id); ?>"
                                                            data-section-name="<?php echo e($section->grade); ?> <?php echo e($section->name); ?>"
                                                            data-grade="<?php echo e(str_replace('G-', '', $section->grade)); ?>"
                                                            title="Assign teachers to subjects">
                                                        <i class="ti ti-users"></i>
                                                    </button>
                                                </div>
                                                <small class="text-muted student-count-<?php echo e($strand->code); ?>-<?php echo e($section->id); ?>">
                                                    0 students
                                                </small>
                                            </div>
                                            <!-- Adviser Selection -->
                                                ...
                                                <select class="form-select form-select-sm adviser-select" 
                                                    ...
                                                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($teacher->id); ?>" 
                                                                data-teacher-name="<?php echo e($teacher->last_name); ?>, <?php echo e($teacher->first_name); ?>">
                                                            <?php echo e($teacher->last_name); ?>, <?php echo e($teacher->first_name); ?>

                                                            <?php if($teacher->middle_name): ?>
                                                                <?php echo e(substr($teacher->middle_name, 0, 1)); ?>.
                                                            <?php endif; ?>
                                                        </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <small class="text-muted adviser-display-<?php echo e($strand->code); ?>-<?php echo e($section->id); ?>" style="display: none;">
                                ...
                                <!-- Grade 12 Sections -->
                                <?php if($grade12Sections->isNotEmpty()): ?>
                                    <div class="list-group-item px-2 py-1 bg-light">
                                        <small class="fw-bold text-success">
                                            <i class="ti ti-school me-1"></i>Grade 12 Sections
                                        </small>
                                    </div>
                                    <?php $__currentLoopData = $grade12Sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $color = $colors[$index % count($colors)];
                                        ?>
                                        <div class="list-group-item px-2 py-2 section-item" data-section="<?php echo e($section->id); ?>" data-grade="12">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div>
                                                    <span class="badge bg-<?php echo e($color); ?>">
                                                        <?php echo e($section->grade); ?> <?php echo e($section->name); ?>
...
<div id="studentAssignmentsData" style="display:none;"><?php echo json_encode(session('student_assignments', []), 512) ?></div>
<div id="savedAdvisersData" style="display:none;"><?php echo json_encode($savedAdvisers ?? [], 15, 512) ?></div>
        ...
        <div class="modal fade" id="modalDisablePreEnrollment" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo e(route('admin.section-advisers.disable-pre-enrollment')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
        ...
        <div class="modal fade" id="modalEndOfSchoolYear" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo e(route('admin.section-advisers.end-of-school-year')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
...
<script>
    ...
    const routes = {
        getStudents: "<?php echo route('admin.section-advisers.get-students'); ?>",
        getSectionStudents: "<?php echo route('admin.section-advisers.get-section-students'); ?>",
        getSectionCounts: "<?php echo route('admin.section-advisers.get-section-counts'); ?>",
        removeStudent: "<?php echo route('admin.section-advisers.remove-student'); ?>",
        saveAdvisers: "<?php echo route('admin.section-advisers.save-advisers'); ?>",
        getSubjects: "<?php echo route('admin.section-advisers.get-subjects'); ?>",
        subjectTeachers: "<?php echo route('admin.section-advisers.subject-teachers'); ?>",
        saveSubjectTeacher: "<?php echo route('admin.section-advisers.save-subject-teacher'); ?>"
    };
...
<?php echo $__env->make('admin.components.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/admin/section_advisers/index.blade.php ENDPATH**/ ?>