        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="text-center mb-4">
                    <img src="<?php echo e(asset('assets/images/Image.png')); ?>" alt="SMAC Logo" height="100" class="mb-2">
                </div>
                <div class="card shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="<?php echo e($actionRoute); ?>" novalidate>
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\NEWSMAC\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>